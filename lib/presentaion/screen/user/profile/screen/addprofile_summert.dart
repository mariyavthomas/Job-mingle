...
class _ProfileSummeryState extends State<ProfileSummery> {
 ...
 @override
  void initState() {
    ...
    profilesummerycontroller=TextEditingController(text: widget.profilesummery);
      ...
      body: Form(
        ...
        child: Column(
          ...
          children: [
            ...
            Center(child: Text("About Me",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20),)),
            SizedBox(
              height: 20,
            ),
            Padding(
               ...
               SizedBox(
                ...
                ElevatedButton(onPressed: (){
                  if(formkey.currentState!.validate()){
                    ...
                    context.read<AboutmeBloc>().add(ProfileSummeryy(profilesummery: aboutme.profilesummery!));
