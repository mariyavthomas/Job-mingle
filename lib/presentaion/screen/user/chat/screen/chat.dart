...
import 'package:jobmingle/presentaion/screen/user/chat/widgets/chatbubble.dart';
import 'package:jobmingle/presentaion/screen/user/chat/widgets/cutom_send.dart';

// ignore: must_be_immutable
class ChatsScreen extends StatefulWidget {
  ChatsScreen({required this.userModel, super.key});
  AppliedJobModel? userModel;
