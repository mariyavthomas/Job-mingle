...
import 'package:jobmingle/domin/models/messagemodel.dart';
...
class MessageRepo extends ChangeNotifier {
  ...
  Future<void> sendMessage(
      String receiverId, String message, AppliedJobModel user, {required String receiverName}) async {
    print(receiverId);
  ...
  Future<List<AppliedJobModel>> getChatUsers(String searchQuery) async {
    final String currentUid = _fireAuth.currentUser!.uid;
    final List<AppliedJobModel> chatUsersList = [];
    try {
      ...
      chatListSnapshot.docs.forEach((doc) {
        ...
        if (data != null) {
          ...
          final userModel = AppliedJobModel.fromJson(userModelJson);
